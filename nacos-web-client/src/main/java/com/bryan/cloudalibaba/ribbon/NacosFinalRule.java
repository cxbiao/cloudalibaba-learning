        ...
        try {
            ...
            if (StringUtils.isNotBlank(targetVersion)) {
                ...
                if (CollectionUtils.isEmpty(metadataMatchInstances)) {
                    log.warn("can't find matched metadata instances。targetVersion = {}, instance = {}", targetVersion, instances);
                    return null;
                }
            }
            ...
            if (StringUtils.isNotBlank(clusterName)) {
                ...
                if (CollectionUtils.isEmpty(clusterMetadataMatchInstances)) {
                    ...
                    log.warn("A cross-cluster call occurs。clusterName = {}, targetVersion = {}, clusterMetadataMatchInstances = {}", clusterName, targetVersion, clusterMetadataMatchInstances);
                }
            }
